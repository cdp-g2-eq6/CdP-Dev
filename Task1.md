...
| 37 | 44 | 43 | **Configurer Github Actions pour vérifier le build à chaque push et pull request sur main.** Todo: dod | 5 |
| 37 | 45 | 43 | **Avoir une page d'accueil vide, mais qui fonctionne**. Todo: dod (ajouter la route "/" dans routes.js, définir la template .ejs à utiliser pour cette route) | 3 |

### US 2

| US | ID | Dépendance(s) | DOD | Coût |
|----|----|---------------|-----|------|
| 2  | 46 | 43 | **Créer un nouveau composant pour la barre de navigation.** Todo: dod | Todo |
| 2  | 47 | 46, 45 | **Ajouter la barre de navigation à la page principale** Todo: dod | Todo |